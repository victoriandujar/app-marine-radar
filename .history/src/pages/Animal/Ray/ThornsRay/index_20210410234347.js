      ...
      <Container>
        <ContainerAnimal>
          ...
          <BackgroundText>
            ...
            <ContainerAboutAnimal>
              <TextAboutAnimal>
                Conhecida como raia-viola-de-espinhos, é uma espécie de
                raia-viola que habita a região do Indo-Pacífico tropical. É a
                única espécie conhecida que pertence ao gênero Rhina, e pertence
                á família Rhinidae. É considerada uma espécie dócil para os
                humanos. Embora suas grandes nadadeiras dorsais e cauda forte o
                façam parecer um tubarão, ela é na verdade um tipo de raia,
                tanto que sempre é confundido com um tubarão.
              </TextAboutAnimal>
            </ContainerAboutAnimal>
          </BackgroundText>
        </ContainerAnimal>
