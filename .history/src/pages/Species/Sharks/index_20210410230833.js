...
export default function Sharks({ navigation }) {
  const { setTitle } = useTitle('');
  setTitle('Espécies - Tubarões');
        ...
        <ContainerSpecies>
          ...
          <ContentSpecies>
            ...
            <LinkSpecies>
              ...
              <ButtonSpecies onPress={() => navigation.navigate('WhiteShark')}>
        ...
        <ContainerSpecies>
          ...
          <ContentSpecies>
            ...
            <LinkSpecies>
              ...
              <ButtonSpecies onPress={() => navigation.navigate('HammerShark')}>
                <Icon name="east" size={14} color="#25C1AF" />
              </ButtonSpecies>
            </LinkSpecies>
          </ContentSpecies>
        ...
        <ContainerSpecies>
          ...
          <ContentSpecies>
            ...
            <LinkSpecies>
              ...
              <ButtonSpecies onPress={() => navigation.navigate('TigerShark')}>
                <Icon name="east" size={14} color="#25C1AF" />
              </ButtonSpecies>
            </LinkSpecies>
          </ContentSpecies>
