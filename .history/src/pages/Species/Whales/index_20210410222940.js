...
export default function Whales({ navigation }) {
    ...
    <Wrapper>
      ...
      <Container>
        ...
        <ContainerSpecies>
          ...
          <ContentSpecies>
            ...
            <LinkSpecies>
              ...
              <ButtonSpecies onPress={() => navigation.navigate('Minke')}>
                <Icon name="east" size={14} color="#25C1AF" />
              </ButtonSpecies>
            </LinkSpecies>
          </ContentSpecies>
        ...
        <ContainerSpecies>
          <Background source={BackgroundImg} />
          <ContentSpecies>
            <SubTitleSpecies>Eschrichtius robustus</SubTitleSpecies>
            <LinkSpecies>
              <TextSpecies>Baleia-cinzenta</TextSpecies>
              <ButtonSpecies onPress={() => navigation.navigate('GrayWhale')}>
                <Icon name="east" size={14} color="#25C1AF" />
              </ButtonSpecies>
            </LinkSpecies>
          </ContentSpecies>
