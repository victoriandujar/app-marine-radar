      ...
      <Container>
        ...
        <ContainerSpecies>
          ...
          <ContentSpecies>
            ...
            <LinkSpecies>
              <TextSpecies>Arraias de Espinhos</TextSpecies>
        ...
        <ContainerSpecies>
          ...
          <ContentSpecies>
            ...
            <LinkSpecies>
              <TextSpecies>Arraias Prego</TextSpecies>
        ...
        <ContainerSpecies>
          <Background source={BackgroundImg} />
          <ContentSpecies>
            <SubTitleSpecies>Dasyatis sabina</SubTitleSpecies>
            <LinkSpecies>
              <TextSpecies>Arraia do Atlântico</TextSpecies>
              <ButtonSpecies onPress={() => navigation.navigate('Animal')}>
                <Icon name="east" size={14} color="#25C1AF" />
              </ButtonSpecies>
            </LinkSpecies>
