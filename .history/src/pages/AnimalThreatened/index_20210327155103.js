...
import { StatusBar, Image, Text, BackHandler } from 'react-native';
    ...
    <Wrapper>
      ...
      <Container>
        <ContainerAnimal>
          ...
          <BackButton>
            <Icon name="west" size={14} color="#d43c3c" />
          </BackButton>
          ...
          <BackgroundText>
            ...
            <ContainerAboutAnimal>
              <TextAboutAnimal>
                Considerada o maior animal do planeta. A IUCN (International
                Unior for Conservation of Nature), classifica a baleia-azul como
                “em perigo” o que significa que esses seres correm sério risco
                de extinção. Atualmente, as estimativas globais dão conta de
                10.000-25.000 indivíduos dessa espécie, correspondente a
                aproximadamente 3-11% da sua população em 1911.
              </TextAboutAnimal>
            </ContainerAboutAnimal>
          </BackgroundText>
        </ContainerAnimal>
